...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/mac/mac_os_10_11_6-init.sh

# mac_os_10_11_6-init.sh
# Initialize Mac OS X El-Capitan 10.11.6 virtual machine.
