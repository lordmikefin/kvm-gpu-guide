...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/mac/mac_os_10_11_6_u20.sh

# mac_os_10_11_6_u20.sh
# Run Mac OS X El-Capitan 10.11.6 virtual machine.  Host Ubuntu 20.04
