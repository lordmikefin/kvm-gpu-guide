...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_10_clean_20.sh

# windows_10_clean_20.sh
# Start windows 10 virtual machine.

# This is new clean installatioon of win 10. Host Ubuntu 20.04
# My previous vm is full of testing and I need new clean test ground ;)
...
KVM_WORKSPACE_VM_WIN10="${KVM_WORKSPACE}/vm/windows_10_clean_20"
OVMF_VARS_WIN10="${KVM_WORKSPACE_VM_WIN10}/windows_10_clean_20_VARS.fd"
VM_DISK_WIN10="${KVM_WORKSPACE_VM_WIN10}/windows_10_clean_20.qcow2"
#KVM_WORKSPACE_SOFTWARE="${KVM_WORKSPACE}/software"
VM_DISK_DATA="${KVM_WORKSPACE_VM_WIN10}/windows_10_clean_20_data_d_drive.qcow2"
