...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_11_unattend_win11-init.sh

# windows_11_unattend_win11-init.sh
# Initialize windows 11 virtual machine.
# Testing how to install Windows 11 with autounattend
# https://schneegans.de/windows/unattend-generator/


# This script will create a new vm into folder ~/kvm-workspace/vm/windows_11_unattend_win11/
...
UNATTEND_FILE="${KVM_WORKSPACE_ISO}/unattend_win11.iso"
