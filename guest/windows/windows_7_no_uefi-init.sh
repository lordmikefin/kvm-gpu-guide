...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_7_no_uefi-init.sh

# windows_7_no_uefi-init.sh
# Initialize windows 7 virtual machine. Host Ubuntu 20.04
# This script will create a new vm into folder ~/kvm-workspace/vm/windows_7_no_uefi/
...
# NOTE: Here is guides to install win7 without OVMF-UEFI
...
KVM_WORKSPACE_VM_WIN7="${KVM_WORKSPACE}/vm/windows_7_no_uefi"
OVMF_VARS_WIN7="${KVM_WORKSPACE_VM_WIN7}/windows_7_no_uefi_VARS.fd"
VM_DISK_WIN7="${KVM_WORKSPACE_VM_WIN7}/windows_7_no_uefi.qcow2"
VM_DISK_DATA="${KVM_WORKSPACE_VM_WIN7}/windows_7_no_uefi_data_d_drive.qcow2"
