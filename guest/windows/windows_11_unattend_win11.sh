...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_11_unattend_win11.sh

# windows_11_unattend_win11.sh
# Start windows 11 virtual machine.
# This vm was installed with autounattend
# https://schneegans.de/windows/unattend-generator/


# This is win 11 vm. Host Ubuntu 20.04

# NOTE: TPM and Secure Boot is not needed because of autounattend settings

unset CURRENT_SCRIPT_VER CURRENT_SCRIPT_DATE
CURRENT_SCRIPT_VER="0.0.1"
CURRENT_SCRIPT_DATE="2024-10-07"
...
KVM_WORKSPACE_VM_WIN11="${KVM_WORKSPACE}/vm/windows_11_unattend_win11"
OVMF_VARS_WIN11="${KVM_WORKSPACE_VM_WIN11}/windows_11_unattend_win11_VARS.fd"
VM_DISK_WIN11="${KVM_WORKSPACE_VM_WIN11}/windows_11_unattend_win11.qcow2"
#KVM_WORKSPACE_SOFTWARE="${KVM_WORKSPACE}/software"
VM_DISK_DATA="${KVM_WORKSPACE_VM_WIN11}/windows_11_unattend_win11_data_d_drive.qcow2"
...
if [[ -n ${SPICE_PORT} ]]; then
	...
	echo " $ spicy --title 'Windows 11 unattend' 127.0.0.1 -p ${SPICE_PORT}"
	echo "You could also use 'remote-viewer'"
	echo " $ remote-viewer --title 'Windows 11 unattend' spice://127.0.0.1:${SPICE_PORT}"
fi
