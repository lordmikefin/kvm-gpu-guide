...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_10_dev_cuda-init.sh

# windows_10_dev_cuda-init.sh
# Initialize windows 10 virtual machine.
# This script will create a new vm into folder ~/kvm-workspace/vm/windows_10_dev_cuda/
