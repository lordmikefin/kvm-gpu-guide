...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_10_clean.sh
...
CURRENT_SCRIPT_DATE="2024-10-27"
...
if [[ -n ${SPICE_PORT} ]]; then
	...
	echo " $ spicy --title 'Windows 10 clean' 127.0.0.1 -p ${SPICE_PORT}"
	echo "You could also use 'remote-viewer'"
	echo " $ remote-viewer --title 'Windows 10 clean' spice://127.0.0.1:${SPICE_PORT}"
fi
