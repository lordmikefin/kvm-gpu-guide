...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_10_desk.sh

# windows_10_desk.sh
# Start windows 10 virtual machine.

# This is win 10 vm. Host Ubuntu 20.04
# This will be my new main desktop. I will be setting all things from my old win7 physical desktop into this vm :)

# NOTE: I tried to create 'Windows 11 desk', but there was strange lag/stutter with it. So back to windows 10 then :)


unset CURRENT_SCRIPT_VER CURRENT_SCRIPT_DATE
CURRENT_SCRIPT_VER="0.0.2"
CURRENT_SCRIPT_DATE="2023-07-18"
...
KVM_WORKSPACE_VM_WIN10="${KVM_WORKSPACE}/vm/windows_10_desk"
OVMF_VARS_WIN10="${KVM_WORKSPACE_VM_WIN10}/windows_10_desk_VARS.fd"
VM_DISK_WIN10="${KVM_WORKSPACE_VM_WIN10}/windows_10_desk.qcow2"
#KVM_WORKSPACE_SOFTWARE="${KVM_WORKSPACE}/software"
VM_DISK_DATA="${KVM_WORKSPACE_VM_WIN10}/windows_10_desk_data_d_drive.qcow2"
VM_DISK_GAMES="${KVM_WORKSPACE_VM_WIN10}/disks/windows_10_desk_games_g_drive.qcow2"
VM_DISK_OLD_GAMES="${KVM_WORKSPACE_VM_WIN10}/disks/windows_10_desk_old_games_o_drive.qcow2"
VM_DISK_STEAM_GAMES="${KVM_WORKSPACE_VM_WIN10}/disks/windows_10_desk_steam_games_s_drive.qcow2"

#EMULATED_TPM="/tmp/emulated_tpm_windows_10_desk"
...
#screen -dmS "emulated_tpm_windows_10_desk" bash -c "swtpm socket --tpmstate dir=${EMULATED_TPM} --ctrl type=unixio,path=${EMULATED_TPM}/swtpm-sock --log level=20 --tpm2"
#
#echo ""
#echo "List all screens."
#echo " $ screen -list"
#echo "Connect to screens."
#echo " $ screen -xS emulated_tpm_windows_10_desk"
...
if [[ -n ${SPICE_PORT} ]]; then
	...
	echo " $ spicy --title 'Windows 10 desk' 127.0.0.1 -p ${SPICE_PORT}"
	echo "You could also use 'remote-viewer'"
	echo " $ remote-viewer --title 'Windows 10 desk' spice://127.0.0.1:${SPICE_PORT}"
fi
...
#echo " $ screen -S emulated_tpm_windows_10_desk -X quit"
#screen -S emulated_tpm_windows_10_desk -X quit
