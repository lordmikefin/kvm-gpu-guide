...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_10_desk-init.sh

# windows_10_desk-init.sh
...
# This script will create a new vm into folder ~/kvm-workspace/vm/windows_10_desk/
...
CURRENT_SCRIPT_DATE="2023-01-05"
...
URL_FILE="Win10_22H2_EnglishInternational_x64.iso"
...
if [[ ! -f "${VM_DISK_WIN10}" ]]; then
	...
	echo ""
	qemu-img create -f qcow2 "${VM_DISK_WIN10}" 64G  || lm_failure
else
