...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_11-init.sh

# windows_11-init.sh
# Initialize windows 11 virtual machine.
# This script will create a new vm into folder ~/kvm-workspace/vm/windows_11/
...
KVM_WORKSPACE_VM_WIN11="${KVM_WORKSPACE}/vm/windows_11"
