...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/windows/windows_10_jao_clean_20-init.sh

# windows_10_jao_clean_20-init.sh
# Initialize windows 10 virtual machine. Host Ubuntu 20.04
# This script will create a new vm into folder ~/kvm-workspace/vm/windows_10_jao_clean_20/
...
KVM_WORKSPACE_VM_WIN10="${KVM_WORKSPACE}/vm/windows_10_jao_clean_20"
OVMF_VARS_WIN10="${KVM_WORKSPACE_VM_WIN10}/windows_10_jao_clean_20_VARS.fd"
VM_DISK_WIN10="${KVM_WORKSPACE_VM_WIN10}/windows_10_jao_clean_20.qcow2"
VM_DISK_DATA="${KVM_WORKSPACE_VM_WIN10}/windows_10_jao_clean_20_data_d_drive.qcow2"
...
# TODO: qemu-system-x86_64: -usbdevice host:046d:c077: '-usbdevice' is deprecated, please use '-device usb-...' instead
#PAR="${PAR} -usb -usbdevice host:046d:c077" # Bus 001 Device 006: ID 046d:c077 Logitech, Inc. M105 Optical Mouse
PAR="${PAR} -device usb-host,046d:c077" # Bus 001 Device 006: ID 046d:c077 Logitech, Inc. M105 Optical Mouse
