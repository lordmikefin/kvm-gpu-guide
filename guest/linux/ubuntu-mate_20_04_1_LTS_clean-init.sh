...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/linux/ubuntu-mate_20_04_1_LTS_clean-init.sh

# ubuntu-mate_20_04_1_LTS_clean-init.sh
# Initialize ubuntu-mate_20_04 virtual machine.
# Clean install for testing LMAutoSetBotUbM
# This script will create a new vm into folder ~/kvm-workspace/vm/ubuntu-mate_20_04_clean/



unset CURRENT_SCRIPT_VER CURRENT_SCRIPT_DATE
CURRENT_SCRIPT_VER="0.0.1"
CURRENT_SCRIPT_DATE="2021-05-24"
...
URL_FILE="ubuntu-mate-20.04.1-desktop-amd64.iso"
URL_PLAIN="cdimage.ubuntu.com/ubuntu-mate/releases/20.04.1/release"
...
KVM_WORKSPACE_VM_UBUNTU="${KVM_WORKSPACE}/vm/ubuntu-mate_20_04_clean"
OVMF_VARS_UBUNTU="${KVM_WORKSPACE_VM_UBUNTU}/ubuntu20_04_clean_VARS.fd"
VM_DISK_UBUNTU="${KVM_WORKSPACE_VM_UBUNTU}/ubuntu20_04_clean.qcow2"
...
if [[ ! -f "${VM_DISK_UBUNTU}" ]]; then
	...
	echo ""
	qemu-img create -f qcow2 "${VM_DISK_UBUNTU}" 100G  || lm_failure
else
