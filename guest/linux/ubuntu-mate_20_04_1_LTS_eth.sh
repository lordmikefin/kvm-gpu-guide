...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/linux/ubuntu-mate_20_04_1_LTS_eth.sh

# ubuntu-mate_20_04_1_LTS_eth.sh
# Start ubuntu-mate_20_04-eth virtual machine for eth mining.



unset CURRENT_SCRIPT_VER CURRENT_SCRIPT_DATE
CURRENT_SCRIPT_VER="0.0.9"
CURRENT_SCRIPT_DATE="2022-08-23"
