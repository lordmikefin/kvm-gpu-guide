...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/linux/ubuntu-mate_18_04_4_LTS_eth-init.sh

# ubuntu-mate_18_04_4_LTS_amd-init.sh
# Initialize ubuntu-mate_18_04 virtual machine for testing AMD Radeon RC570.
# This script will create a new vm into folder ~/kvm-workspace/vm/ubuntu-mate_18_04-amd/



unset CURRENT_SCRIPT_VER CURRENT_SCRIPT_DATE
CURRENT_SCRIPT_VER="0.0.1"
CURRENT_SCRIPT_DATE="2020-10-30"
...
URL_FILE="ubuntu-mate-18.04.4-desktop-amd64.iso"
URL_PLAIN="cdimage.ubuntu.com/ubuntu-mate/releases/18.04.4/release"
...
KVM_WORKSPACE_VM_UBUNTU="${KVM_WORKSPACE}/vm/ubuntu-mate_18_04-amd"
OVMF_VARS_UBUNTU="${KVM_WORKSPACE_VM_UBUNTU}/ubuntu18_04_VARS-amd.fd"
VM_DISK_UBUNTU="${KVM_WORKSPACE_VM_UBUNTU}/ubuntu18_04-amd.qcow2"
