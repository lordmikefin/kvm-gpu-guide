...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/linux/ubuntu-mate_20_04_1_LTS_myst.sh

# ubuntu-mate_20_04_1_LTS_myst.sh
# Start ubuntu-mate_20_04-myst virtual machine for myst mining.
...
CURRENT_SCRIPT_DATE="2021-04-11"
...
KVM_WORKSPACE_VM_UBUNTU="${KVM_WORKSPACE}/vm/ubuntu-mate_20_04-myst"
OVMF_VARS_UBUNTU="${KVM_WORKSPACE_VM_UBUNTU}/ubuntu20_04_VARS-myst.fd"
VM_DISK_UBUNTU="${KVM_WORKSPACE_VM_UBUNTU}/ubuntu20_04-myst.qcow2"
