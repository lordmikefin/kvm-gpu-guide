...
# Initialize ubuntu-mate_18_04 virtual machine for testing eth mining.
# This script will create a new vm into folder ~/kvm-workspace/vm/ubuntu-mate_18_04-game/



unset CURRENT_SCRIPT_VER CURRENT_SCRIPT_DATE
CURRENT_SCRIPT_VER="0.0.2"
CURRENT_SCRIPT_DATE="2020-05-10"
...
OVMF_VARS_UBUNTU="${KVM_WORKSPACE_VM_UBUNTU}/ubuntu18_04_VARS-eth.fd"
