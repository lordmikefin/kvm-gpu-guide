...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/linux/ubuntu-mate_18_04_4_LTS_game-init.sh

# ubuntu-mate_18_04_4_LTS_game-init.sh
# Initialize ubuntu-mate_18_04 virtual machine for testing games.
...
CURRENT_SCRIPT_DATE="2020-03-29"
