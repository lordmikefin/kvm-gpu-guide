...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/linux/ubuntu-mate_18_04_4_LTS_eth.sh

# ubuntu-mate_18_04_4_LTS_amd.sh
# Start ubuntu-mate_18_04_4 virtual machine for testing AMD Radeon RC570.
