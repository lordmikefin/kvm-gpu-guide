...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/linux/ubuntu-mate_18_04_4_LTS_game.sh

# ubuntu-mate_18_04_4_LTS_game.sh
# Start ubuntu-mate_18_04_4 virtual machine for testing games.
