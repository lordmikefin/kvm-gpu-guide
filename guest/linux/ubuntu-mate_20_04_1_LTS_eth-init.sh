...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/linux/ubuntu-mate_20_04_1_LTS_eth-init.sh

# ubuntu-mate_20_04_1_LTS_eth-init.sh
# Initialize ubuntu-mate_20_04-eth virtual machine for eth mining.
# This script will create a new vm into folder ~/kvm-workspace/vm/ubuntu-mate_20_04-eth/
