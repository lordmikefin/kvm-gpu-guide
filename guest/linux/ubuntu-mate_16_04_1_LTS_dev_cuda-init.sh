...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/linux/ubuntu-mate_16_04_1_LTS_dev_cuda-init.sh

# ubuntu-mate_16_04_1_LTS_dev_cuda-init.sh
...
# $ qemu-img create -f qcow2 /opt/kvm/vm_storage/ubuntu16_04_dev_cuda.qcow2 20G
# $ cp -v /usr/share/OVMF/OVMF_VARS.fd /opt/kvm/vm_storage/ubuntu16_04_dev_cuda_VARS.fd
