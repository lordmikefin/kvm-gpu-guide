...
#   https://github.com/lordmikefin/kvm-gpu-guide/blob/master/guest/bsd/ghostbsd_22_01_12-init.sh

# ghostbsd_22_01_12-init.sh
# Initialize ghostbsd_22_01_12 virtual machine.
# This script will create a new vm into folder ~/kvm-workspace/vm/ghostbsd_22_01_12/


unset CURRENT_SCRIPT_VER CURRENT_SCRIPT_DATE
CURRENT_SCRIPT_VER="0.0.1"
CURRENT_SCRIPT_DATE="2022-05-29"
...
URL_FILE="GhostBSD-22.01.12.iso"
URL_PLAIN="download.fr.ghostbsd.org/releases/amd64/22.01.12"
